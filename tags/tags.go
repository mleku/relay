// Package tags provides a set of tools for composing and searching lists of tag.T as well as
...
// AppendSlice just appends a slice of slices of bytes into the tags. Like AppendTo but without
// the position specifier. todo: this is a terribly constructed API innit.
...
// Clone makes a copy of all the elements of a tags.T into a new tags.T.
func (t *T) Clone() (c *T) {
...
// AppendUnique appends a tag if it doesn't exist yet, otherwise does nothing. the uniqueness
// comparison is done based only on the first 2 elements of the tag.
...
// MarshalTo appends the JSON encoded byte of T as [][]string to dst. String escaping is as
// described in RFC8259.

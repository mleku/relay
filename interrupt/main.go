// Package interrupt is a library for providing handling for Ctrl-C/Interrupt handling and
// triggering callbacks for such things as closing files, flushing buffers, and other elements

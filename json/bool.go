...
//
// this is a shortcut evaluation because any text not in quotes in JSON is invalid so if it is
// something other than the exact correct, the next value will not match and the larger
// structure being unmarshalled will fail with an error.

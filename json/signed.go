...
// there is no such thing as any negative integers, nor floating point, but this ensures if
// there is ever need for negative values they are supported. For the most part this will be
// used for timestamps.
//

// Package timestamp is a set of helpers for working with timestamps including encoding and
// conversion to various integer forms, from time.Time and varints.
package timestamp
...
// Time converts a timestamp.Time value into a canonical UNIX 64 bit 1-second precision
// timestamp.

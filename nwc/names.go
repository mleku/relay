...
// Response.ResultType in a form that allows more convenient reference than using a map or
// package scoped variable. These appear in the API Request and Response types.
var Methods = struct {
	PayInvoice,
	MultiPayInvoice,
	PayKeysend,
...
// Keys are the proper JSON bytes for the JSON object keys of the structs of the same-named type
// used lower in the following. Anonymous struct syntax is used to make neater addressing of
// these fields as symbols.
var Keys = struct {
	Method,
	Params,
	ResultType,

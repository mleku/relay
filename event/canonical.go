...
// FromCanonical reverses the process of creating the canonical encoding, note that the
// signature is missing in this form. Allocate an event.T before calling this.

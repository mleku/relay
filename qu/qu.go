// Package qu is a library for making handling signal (chan struct{}) channels simpler, as well
// as monitoring the state of the signal channels in an application.
package qu
...
// Signal sends struct{}{} on the channel which functions as a momentary switch, useful in pairs
// for stop/start.
func (c C) Signal() {
...
// testChanIsClosed allows you to see whether the channel has been closed so you can avoid a
// panic by trying to close or signal on it.

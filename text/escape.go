...
//
//	No whitespace, line breaks or other unnecessary formatting should be included in the output
//	JSON. No characters except the following should be escaped, and instead should be included
//	verbatim:
//
